    ...
    return (
        <div className='min-h-screen grid place-items-center bg-slate-700 text-white'>
            ...
            <div>
                ...
                {gameStatus === "won" ? <p className='text-center text-2xl text-green-400'>Congratulations!</p>:<br/>}
                {gameStatus === "lost" ? <p className='text-center text-2xl text-red-500'>You lost! the correct pokemon was:"{chosenPokemon.name.toUpperCase()}"</p> : <br />}
                <div className='my-5'>
